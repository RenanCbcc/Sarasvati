...
public class Helper {
	...
	public static String musicPath = "D:/Musicas";
	...
	public static File nowPlaying;// caminho da musica atual
	...
	// esta function carregas as imagens do argumento 'path'
	...
	public static void getMusic() {
		...
		File folder = new File(musicPath);// "D:/Musicas";
	...
	public static ArrayList<String> getFolders() {
		...
		File folder = new File(musicPath); // "D:/Músicas";
		File[] listOfFiles = folder.listFiles();
	...
	public static String getNextSong() {
		Helper.musicPlayer.getFastForward().setImage(Helper.proximo);
	...
	public static BufferedImage changeImageColor(BufferedImage img, Color color) {
		...
		for (int y = 0; y < img.getHeight(); y++) {
			for (int x = 0; x < img.getWidth(); x++) {
				...
				int rgb = (alpha << 24) & 0xFF000000 | (color.getRed() << 16) & 0x00FF0000
						| (color.getGreen() << 8) & 0x0000FF00 | color.getBlue() & 0x000000FF;
